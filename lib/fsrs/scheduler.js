...
const {
  ...
  // FSRS Personal Optimizer (Phần 3/4/6/7): isValidWeightsArray/getRetrievability thêm vào lib/fsrs.js
  // để optimizer.js dùng LẠI qua đúng con đường này — không tự import "ts-fsrs" hay tự viết công
  // thức forgetting curve ở lib/fsrs/optimizer.js.
  isValidWeightsArray,
  getRetrievability,

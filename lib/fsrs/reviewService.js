...
// V98 fix ("Hôm nay học không tuân theo Cài đặt hằng ngày"): tách phần tính "còn được học/ôn bao
// nhiêu hôm nay" (dailyReviewLimit/dailyNewLimit/unlimitedStudy/newOnlyAfterDue trừ đi số đã làm
// hôm nay) thành 1 hàm DÙNG CHUNG cho cả getTodayOverview() (dashboard) VÀ getStudySession() (phiên
// học thật) — TRƯỚC ĐÂY chỉ getStudySession() áp dụng, còn getTodayOverview() luôn trả về due/new
// TOÀN BỘ backlog trong phạm vi, không hề trừ theo Cài đặt hằng ngày — nên đổi "Giới hạn ôn tập/
// ngày"/"Giới hạn từ mới/ngày" (hoặc bật "Học không giới hạn") KHÔNG hề làm đổi số hiển thị ở khối
// "Hôm nay học"/"at a glance" Trang chủ, dù bấm "Bắt đầu học" thực tế lại bị giới hạn đúng như cài
// đặt — trông như cài đặt không có tác dụng. Dùng chung hàm này đảm bảo 2 nơi KHÔNG BAO GIỜ lệch nhau.

...
async function submitFsrsReview({ word, quizType, selectedAnswer, responseTimeMs, answerChanges }) {
  const payload = {
...
let sessionKnownHz = new Set(); // V74: hz đã trả lời ĐÚNG ở BẤT KỲ tab luyện tập nào trong phiên hiện tại
